...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='TSMixer',
                        help='model name, options: [Autoformer, Informer, Transformer,\
                            iTransformer, PatchMixer, Reformer, SegRNN]')

    # data loader
    parser.add_argument('--data', type=str, default='Close', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./dataset/', help='root path of the data file')
    parser.add_argument('--data_path', type=str, default='close_data.csv', help='data file')
